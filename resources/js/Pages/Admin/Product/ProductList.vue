...
const deleteImage = async (image, index) => {
    try {
        await router.delete("/admin/products/imageDelete/" + image.id, {
            onSuccess: (page) => {
...
<template>
    <div>
        <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
            <!-- dialog for adding product or edit product -->
            <el-dialog
            ...
            >
                ...
                >
                    ...
                    <!-- showing multiple img of product -->
                    <div class="flex flex-nowrap mb-8">
                        <div
                            v-for="(image, index) in product_images"
                            :key="image.id"
                            class="relative w-32 h-30"
                        >
                            <img
                            ...
                            <span
                                ...
                                class="absolute cursor-pointer top-0 right-8 transform -translate-y-1/2 w-3.5 h-3.5 bg-red-400 border-2 border-white dark:border-gray-800 rounded-full"
                            >
                                <span
                    ...
                    <button
                        type="submit"
                        class="text-white bg-blue-400 hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-sm w-full sm:w-auto px-3 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                    >
                        Submit Changes
                    </button>
                </form>
