                            ...
                            >
                                ...
                                >
                                    ...
                                    <form class="mt-4 border-t border-gray-200">
                                        <!-- price mobile filter -->
                                        <div
                                            class="flex items-center justify-between space-x-3 m-5"
                                        >
                                            <div class="basis-1/3">
                                                <label
                                        ...
                                        <!--end price mobile filter -->
                                        <!-- Brand mobile filter -->
                                        <Disclosure
                                            as="div"
                                            class="border-t border-gray-200 px-4 py-6 mb-3"
                                            v-slot="{ open }"
                                        >
                                                    ...
                                                    >
                                                        <input
                                                            v-model="
                                                                selectedBrands
                                                            "
                                                            :id="`filter-mobile-${brand.id}`"
                                                            :value="brand.id"
                                                            type="checkbox"
                                                            class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                                                        />
                                                        <label
                                                            :for="`filter-mobile-${brand.id}`"
                                                    ...
                                                    >
                                                        <input
                                                            v-model="
                                                                selectedCategories
                                                            "
                                                            :id="`filter-mobile-${category.id}-category`"
                                                            :value="category.id"
                                                            type="checkbox"
                                                            class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                                                        />
                                                        <label
                                                            :for="`filter-mobile-${category.id}-category`"
                                                            class="ml-3 min-w-0 flex-1 text-gray-500"
                                                            >{{
                                                                category.name
                                                            }}</label
                                        ...
                                        <div class="space-y-4">
                                            ...
                                            >
                                                <input
                                                    ...
                                                    :id="`filter-${category.id}-category`"
                                                    :value="category.id"
                                                    type="checkbox"
                                                    class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                                                />
                                                <label
                                                    :for="`filter-${category.id}-category`"
                                                    class="ml-3 text-sm text-gray-600"
                                                    >{{ category.name }}</label
                                                >
                                            </div>
